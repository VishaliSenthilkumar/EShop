    ...
    <div class="container-fluid"> 
        ...
        <ul class="nav navbar-nav navbar-right">
            ...
            <div style="width:300px;">
                ...
                <input type="email" class="form-control" name="email" id="email" default=" " required/>
                <label for="email">Password</label>
                <input type="password" class="form-control" name="password" id="password" default=" " required/>
                <p><br/></p>
