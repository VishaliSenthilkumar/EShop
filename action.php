        ...
        while ($row = mysqli_fetch_array($run_query)) {
            ...
            <div class='col-md-4'>
                    <div class='panel panel-info'>
                        ...
                        <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Fuga corporis expedita blanditiis nesciunt libero obcaecati, minus laudantium consequuntur maiores esse dolores ut suscipit impedit aperiam vel eligendi unde autem explicabo.
                        </p>
                        </div>
                        <div class='panel-heading'><div>$$pro_price
...
if(isset($_POST["get_seleted_Category"]) || isset($_POST["selectbrand"])  || isset($_POST["search"])){
    ...
    while($row = mysqli_fetch_array($run_query)){
            ...
            <div class='col-md-4'>
                    <div class='panel panel-info'>
                        <div class='panel-heading panel-title'>$pro_title</div>
                        <div class='panel-body text-center'> 
                            <img class='' src='product_images/$pro_image' style='width:160px; height:250px;/></div>
                        <div class = 'panel-body'>
                        <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Fuga corporis expedita blanditiis nesciunt libero obcaecati, minus laudantium consequuntur maiores esse dolores ut suscipit impedit aperiam vel eligendi unde autem explicabo.
                        </p>
                        </div>
